...
LABELS = {
    ...
    "star_align_pass1": ("STAR pass 1 (2-pass)", "Per sample"),
    "star_merge_junctions": ("merge splice junctions", "Per sample"),
    "samtools_flagstat": ("samtools flagstat", "Per sample"),
    "rseqc_infer_experiment": ("RSeQC infer_experiment", "Per sample"),
    "rseqc_read_distribution": ("RSeQC read distribution", "Per sample"),
    "rseqc_gene_body_coverage": ("RSeQC gene body coverage", "Per sample"),
    ...
    "telocal_locations": ("TElocal locations", "Reference (once)"),
    ...
    "chimera_reads_classify": ("classify chimeric junctions", "Chimera screen"),
    "chimera_telocal_annotate": ("annotate junctions with TElocal counts", "Chimera screen"),
    "chimera_reads_qc": ("junction QC", "Chimera screen"),
    "chimera_reads_qc_barplot": ("junction QC barplot", "Chimera screen"),
    "chimera_reads_highlights": ("read-screen notes (blind spot + counts)", "Chimera screen"),
    ...
    "chimera_assembly_qc_transform": ("assembly QC matrix (log2)", "Chimera screen"),
    "chimera_assembly_qc": ("assembly PCA + sample clusters", "Chimera screen"),
    "chimera_reads_igv_bed": ("IGV BED track", "Chimera screen"),
    "chimera_reads_counts": ("chimera counts matrix", "Chimera screen"),
    "chimera_reads_sample_qc_transform": ("sample-QC transform", "Chimera screen"),
    "chimera_reads_sample_qc": ("sample-QC plots", "Chimera screen"),
